...
@implementation KMBasePaiHaoCell
...
-(void)km_addSubviews{
    ...
    _topGrayLine                    = [UIView new];
    [contentView addSubview:_topGrayLine];
...
-(void)km_setupSubviewsLayout{
    ...
    [_topGrayLine mas_makeConstraints:^(MASConstraintMaker *make) {
