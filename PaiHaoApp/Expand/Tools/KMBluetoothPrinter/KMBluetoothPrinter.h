...
typedef NS_ENUM(NSInteger, KM_PrinterStyle) {
    KM_PrinterStyleDefault,
    KM_PrinterStyleCustom
};

/** 文字对齐方式 */
typedef NS_ENUM(NSInteger, KM_TextAlignment) {
    KM_TextAlignmentLeft = 0x00,
    KM_TextAlignmentCenter = 0x01,
    KM_TextAlignmentRight = 0x02
};

/** 字号 */
typedef NS_ENUM(NSInteger, KM_FontSize) {
    KM_FontSizeTitleSmalle = 0x00,
    KM_FontSizeTitleMiddle = 0x11,
    KM_FontSizeTitleBig = 0x22
};

@interface KMBluetoothPrinter : NSObject
/**
 *  换行
 */
- (void)appendNewLine;
