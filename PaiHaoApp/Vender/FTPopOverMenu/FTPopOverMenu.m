...
-(UITableView *)menuTableView
{
    if (!_menuTableView) {
        ...
        //add
        _menuTableView.layoutMargins = UIEdgeInsetsZero;
        _menuTableView.separatorColor = [[UIColor whiteColor] colorWithAlphaComponent:0.7];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == _menuStringArray.count-1) {
        ...
        //add
        [menuCell km_setSeparatorLineInset:UIEdgeInsetsZero];
    }
    return menuCell;
}
